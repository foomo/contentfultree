		...
		case 'PAGE':
			return _jsx(StyledIcon, {
				children: _jsxs('svg', {
					...
					children: [
						_jsx('defs', {}),
						_jsx('title', { children: 'Asset 47ldpi' }),
						_jsx('g', {
							id: 'Layer_2',
							'data-name': 'Layer 2',
							children: _jsxs('g', {
								...
								children: [
									...
									_jsx('rect', { x: '34', y: '25', width: '8', height: '2' }),
									_jsx('rect', { x: '22', y: '25', width: '10', height: '2' }),
									_jsx('rect', { x: '31', y: '30', width: '7', height: '2' }),
									_jsx('rect', { x: '22', y: '30', width: '7', height: '2' }),
									_jsx('rect', { x: '36', y: '35', width: '6', height: '2' }),
									_jsx('rect', { x: '22', y: '35', width: '12', height: '2' }),
									_jsx('rect', { x: '22', y: '40', width: '9', height: '2' }),
									_jsx('path', {
									...
									_jsx('rect', { x: '4', y: '4', width: '2', height: '2' }),
									_jsx('rect', { x: '8', y: '4', width: '2', height: '2' }),
									_jsx('rect', { x: '12', y: '4', width: '2', height: '2' }),
									_jsx('rect', { x: '1', y: '8', width: '46', height: '2' }),
								],
							}),
						}),
					],
					...
					children: [
						...
						_jsxs('g', {
							...
							children: [
								...
								_jsx('rect', { x: '6', y: '26', width: '2', height: '2' }),
								_jsx('path', {
									d: 'M15,7V5H7A1,1,0,0,0,6,6v4a1,1,0,0,0,1,1h8V9H8V7Z',
								}),
								_jsx('rect', { x: '6', y: '14', width: '2', height: '2' }),
								_jsx('rect', { x: '10', y: '14', width: '2', height: '2' }),
								_jsx('path', {
				...
				children: _jsx('svg', {
					...
					children: _jsxs('g', {
						...
						children: [
							...
							_jsx('path', { d: 'M18 12h-2V9h-4V7h6v5z' }),
							_jsx('path', {
