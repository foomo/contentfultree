...
var ContentTreeRoot = function (_a) {
	var node = _a.node,
		sdkInstance = _a.sdkInstance,
		cma = _a.cma,
		nodeContentTypes = _a.nodeContentTypes,
	...
	var loadRootData = function (rootNode) {
		return __awaiter(void 0, void 0, void 0, function () {
			var childEntries, childNodes, nodes, newIdPositionMap_1, tree_1
			return __generator(this, function (_a) {
				switch (_a.label) {
					case 0:
						return [4, getContentfulChildEntries(rootNode.id)]
					case 1:
	...
	var getContentfulChildEntries = function (parentId) {
		return __awaiter(void 0, void 0, void 0, function () {
			var parentItem,
				allChildIds,
				_i,
